            ...
            <div className="bg-black/40 backdrop-blur-2xl border border-white/20 rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 lg:p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  ...
                  <button className="bg-green-300 text-black px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-medium hover:bg-green-400 transition-all duration-300 hover:scale-105 text-sm sm:text-base touch-manipulation">
                    Contact Us
                  </button>
                </div>
              </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full" style={{ transform: 'translateZ(20px)' }}>
                    ...
                    <div className="mt-auto pt-3 sm:pt-4 pb-2">
                      <button 
