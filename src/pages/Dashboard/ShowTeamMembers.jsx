...
import {
  ...
  PlusCircle, Image as ImageIcon, Loader2, Eye, Users, User,
  Briefcase, List, Globe, Linkedin, Twitter, Mail, Phone,
  Shield, CheckCircle, X, Save, Edit3, Hash, Facebook, Settings
} from 'lucide-react';
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
            <div className="flex-1 relative">
              <input
                value={q}
                onChange={e => setQ(e.target.value)}
                placeholder="Search name, position, skills, email, or phone..."
                className="w-full pl-12 pr-4 py-3 rounded-xl border border-[#E5E0D5] focus:outline-none focus:ring-2 focus:ring-[#0A3D91] focus:border-[#0A3D91] bg-white text-[#0A3D91]"
              />
              <Search className="w-5 h-5 text-[#D0A96A] absolute left-4 top-1/2 -translate-y-1/2" />
            </div>
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => setEditing({
                  name: '', position: '', bio: '', expertise: [], image: '',
                  email: '', phone: '',
                  order: 999, active: true,
                ...
                >
                  ...
                  <div className="px-6 pb-4">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {m.email && (
                        <a href={`mailto:${m.email}`} className="px-2 py-1 rounded-lg text-xs bg-white border border-[#E5E0D5] text-[#0A3D91] inline-flex items-center gap-1">
                          <Mail className="h-3 w-3" /> {m.email}
                        </a>
                      )}
                      {m.phone && (
                        <a href={`tel:${m.phone}`} className="px-2 py-1 rounded-lg text-xs bg-white border border-[#E5E0D5] text-[#0A3D91] inline-flex items-center gap-1">
...
function ViewMemberModal({ member, onClose, onEdit }) {
  ...
  const modal = (
    <div className="fixed inset-0 z-[9999]">
      ...
      {/* Modal Container (centered & padded) */}
      <motion.div
        ...
        onMouseDown={(e) => e.stopPropagation()}
      >
        {/* Dialog Card with bounded height */}
        <div className="w-[95vw] max-w-4xl max-h-[90vh] overflow-hidden rounded-3xl shadow-2xl border border-[#E5E0D5] bg-[#FBF8F3]">
          {/* Sticky Header */}
          <div className="sticky top-0 z-10 bg-gradient-to-r from-[#0A3D91] to-[#08306B] p-8 relative">
            <button
              onClick={onClose}
              className="absolute top-4 right-4 p-2 text-white hover:bg-white/20 rounded-xl transition-colors"
            >
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3">
                  <span className={`px-3 py-1 rounded-xl text-sm font-semibold ${
                    member.active ? 'bg-[#D0A96A] text-white' : 'bg-[#6B7280]/30 text-[#FDF6E9]'
                  }`}>
                    {member.active ? 'Active' : 'Inactive'}
                  </span>
                  <span className="px-3 py-1 rounded-xl text-sm font-medium bg-white/20 text-white">
          ...
          {/* Scrollable Content */}
          <div className="overflow-y-auto overscroll-contain max-h-[calc(90vh-6rem)] p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Left Column */}
              <div className="space-y-6">
                {/* Bio */}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#FDF6E9] p-6 rounded-2xl border border-[#E5E0D5]">
                  ...
                  <div className="space-y-3">
                    {member.email ? (
                      <a href={`mailto:${member.email}`} className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#E5E0D5] hover:bg-[#0A3D91]/5 transition-colors">
                        <Mail className="h-5 w-5 text-[#0A3D91]" />
                        <span className="text-[#0A3D91] font-medium">{member.email}</span>
                      </a>
                    ) : null}
                    {member.phone ? (
                      <a href={`tel:${member.phone}`} className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#E5E0D5] hover:bg-[#0A3D91]/5 transition-colors">
                        <Phone className="h-5 w-5 text-[#0A3D91]" />
                        <span className="text-[#0A3D91] font-medium">{member.phone}</span>
                      </a>
                    ) : null}
                  </div>
                </div>
                ...
                <div className="bg-[#FDF6E9] p-6 rounded-2xl border border-[#E5E0D5]">
                  ...
                  <div className="space-y-3">
                    {member.socials?.linkedin && (
                      ...
                      >
                        <Linkedin className="h-5 w-5 text-[#0A3D91]" />
                        <span className="text-[#0A3D91] font-medium">LinkedIn</span>
                      </a>
                    )}
                    {member.socials?.twitter && (
                      <a
                      ...
                      >
                        <Twitter className="h-5 w-5 text-[#0A3D91]" />
                        <span className="text-[#0A3D91] font-medium">Twitter / X</span>
                      </a>
                    )}
                    {member.socials?.facebook && (
                      <a
                        ...
                        className="flex items-center gap-3 p-3 bg-[#0A3D91]/5 rounded-xl hover:bg-[#0A3D91]/10 transition-colors"
                      >
                        <Facebook className="h-5 w-5 text-[#0A3D91]" />
                        <span className="text-[#0A3D91] font-medium">Facebook</span>
                      </a>
                    )}
                    {!member.socials?.linkedin && !member.socials?.twitter && !member.socials?.facebook && (
                      <p className="text-[#6B7280] italic">No social links provided</p>
                    )}
                  </div>
                </div>
                ...
                <div className="bg-[#FDF6E9] p-6 rounded-2xl border border-[#E5E0D5]">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center py-2 border-b border-[#E5E0D5]">
                      <span className="text-[#6B7280] font-medium">Status:</span>
                      <span className={`px-2 py-1 rounded-lg text-sm font-semibold ${
                        member.active ? 'bg-[#D0A96A] text-white' : 'bg-[#6B7280]/20 text-[#6B7280]'
                      }`}>
                        {member.active ? 'Active' : 'Inactive'}
                      </span>
                    </div>
          ...
          {/* Sticky Footer */}
          <div className="sticky bottom-0 z-10 bg-[#FBF8F3] border-t border-[#E5E0D5] px-8 py-6 flex justify-end gap-3">
            <button
              onClick={onClose}
              className="px-6 py-3 rounded-xl border border-[#E5E0D5] text-[#6B7280] hover:bg-[#6B7280]/5 transition-colors font-semibold"
            >
  ...
  const modal = (
    <div className="fixed inset-0 z-[9999]">
      ...
      <motion.div
        ...
        onMouseDown={(e) => e.stopPropagation()}
      >
        {/* Form Card with bounded height */}
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="w-[95vw] max-w-4xl max-h-[90vh] overflow-hidden rounded-3xl shadow-2xl border border-[#E5E0D5] bg-[#FBF8F3]"
        >
          {/* Sticky Header */}
          <div className="sticky top-0 z-10 bg-gradient-to-r from-[#0A3D91] to-[#08306B] p-8 relative">
            <button
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#FDF6E9] p-6 rounded-2xl border border-[#E5E0D5]">
                  ...
                  <div className="space-y-4">
                    {/* Email */}
                    <div>
                      <label className="block text-sm font-semibold text-[#0A3D91] mb-2">Email</label>
                      <div className="relative">
                    ...
                    {/* Phone */}
                    <div>
                      <label className="block text-sm font-semibold text-[#0A3D91] mb-2">Phone</label>
                      <div className="relative">
                        <Phone className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-[#D0A96A]" />
                        <input
                          {...register('phone')}
                          className="w-full pl-10 pr-4 py-3 border border-[#E5E0D5] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0A3D91] focus:border-[#0A3D91] bg-white"
                    ...
                    {/* Facebook */}
                    <div>
                      <label className="block text-sm font-semibold text-[#0A3D91] mb-2">Facebook</label>
                      <div className="relative">
                        <Facebook className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-[#D0A96A]" />
                        <input
                          {...register('facebook')}
                          className="w-full pl-10 pr-4 py-3 border border-[#E5E0D5] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0A3D91] focus:border-[#0A3D91] bg-white"
