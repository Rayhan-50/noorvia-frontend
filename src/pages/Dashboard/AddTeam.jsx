...
import { 
  ...
  User, Briefcase, FileText as Bio, Facebook, Twitter, Linkedin, 
  Upload, Eye, Settings, Save, Mail, Phone
} from 'lucide-react';
              ...
              <div className="bg-[#FDF6E9] p-8 rounded-2xl border border-[#E5E0D5] shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  <div>
                    ...
                    {errors.email && <span className="text-[#B91C1C] text-sm mt-1 block">{errors.email.message}</span>}
                  </div>

                  <div>
                    <label className="block text-sm font-semibold text-[#0A3D91] mb-2">Phone Number</label>
                    <div className="relative">
                    ...
                    {errors.phone && <span className="text-[#B91C1C] text-sm mt-1 block">{errors.phone.message}</span>}
                  </div>
                </div>
