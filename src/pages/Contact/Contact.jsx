    ...
    <div>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    ...
                    {/* UPDATED ADDRESS */}
                    <p className="text-xs sm:text-sm text-[#6B7280]">
                      House No. 239, Road-02, Block F<br />
      ...
      <section className="py-12 sm:py-16 bg-[#FAF3E0]">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="bg-white p-3 sm:p-4 rounded-lg sm:rounded-xl shadow-lg border border-[#E5E7EB]">
            {/* UPDATED MAP to Bashundhara R.A address */}
            <iframe
              src="https://www.google.com/maps?q=House%20No.%20239%2C%20Road-02%2C%20Block%20F%2C%20Bashundhara%20R.A%2C%20Dhaka-1229%2C%20Bangladesh&z=16&output=embed"
              className="w-full h-64 sm:h-80 md:h-96 rounded-lg"
              allowFullScreen=""
              loading="lazy"
              title="NoorVia Office Location"
